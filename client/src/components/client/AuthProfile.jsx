...
export default function AuthProfile() {
  ...
  return (
    <section className="bg-primary min-h-screen pb-10">
      ...
      <img src={authProfileBg} alt="Auth Profile" className="w-full h-full object-center object-cover " />
      </div>
      <div className="container mx-auto pb-10 p-2">
        <div className="flex relative justify-end py-3 items-center w-full">
          <div className="w-24 h-24 md:w-32 md:h-32 lg:w-36 lg:h-36 rounded-full bg-violet-400 absolute left-0 transform -translate-y-1/2">
            <img src={authProfileImg} alt="Auth Profile Image" className="w-full h-full object-center object-cover " /></div>
