      ...
      <section className="pt-10">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row">
            <aside className="w-0 md:w-1/4 max-h-screen h-full">
            ...
            <div className="p-5 flex justify-center  w-full">
              <Tabs defaultValue="reading" className="my-5">
                ...
                <TabsContent value="transliteration" className="max-w-3xl">
                  <div className="flex flex-col justify-center min-w-full md:min-w-2xl">
